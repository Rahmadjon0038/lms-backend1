 ...
 *   post:
 *     summary: Talabaning ma'lum oy va guruhdagi to'lov/chegirma ma'lumotlarini tozalash
 *     description: Admin uchun - berilgan student_id, group_id va month bo'yicha payment_transactions, student_payments va shu oyga tegishli student_discounts yozuvlarini o'chirish
 *     tags: [Payments]
 *     security:
 *       - bearerAuth: []
 *     requestBody:
 ...
 *     responses:
 *       200:
 *         description: Ko'rsatilgan oy/guruh bo'yicha ma'lumotlar tozalandi
 *       403:
 *         description: Faqat adminlar uchun
 *       404:
 *         description: Student yoki ma'lumot topilmadi
 *       400:
 *         description: Parametrlar xato
 */
 ...
 *     description: |
 *       Talaba o'z to'lov tarixini ko'radi (ma'lum bir oy uchun).
 *       Admin va Super Admin student_id parametri orqali istalgan talabaning tarixini ko'ra oladi.
 *       Agar month parametri berilmasa, joriy oy ishlatiladi.
 *     tags: [Student Payments]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *           type: string
 *           example: "2026-02"
 *         description: Qaysi oy uchun tarix (YYYY-MM format). Agar berilmasa, joriy oy ishlatiladi.
 *       - in: query
 *         name: group_id
 *         schema:
 *           type: integer
 ...
 *                       type: string
 *       400:
 *         description: Noto'g'ri month formati
 *       403:
 *         description: Faqat talabalar uchun
 */
